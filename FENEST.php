      ...
      <div id="infotmacion"  class="infotmacion">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-7">
                  <div class="titlepage">
                     <h2>¿Que es la Federacion Nacional de Escultismo Tradicional de Colombia -FENEST?</h2>
                     <span></span>
                     <p>La “FEDERACIÓN NACIONAL DE ESCULTISMO TRADICIONAL DE COLOMBIA”- FENEST, se define como una organización sin ánimo de lucro al servicio del movimiento Scout, educativo no formal, no político, de carácter voluntario, abierto a todos sin distinción
