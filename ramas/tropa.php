      ...
      <div id="infotmacion"  class="infotmacion">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-7">
                  <div class="titlepage">
                     <h2><FONT COLOR="lime">TROPA</FONT></h2>
                     <span></span>
                     <p>

                     La Tropa Scout es la sección o rama donde los muchachos y muchachas entre 7 y 15 años, forman pequeños grupos denominados Patrullas Scouts. Las Patrullas se forman con el propósito de aprender colectivamente, trabajar en equipo, apoyarse mutuamente en su desarrollo personal, comprometerse en un proyecto común e interactuar con otros grupos similares.

<b>Datos Técnicos:
Unidad o Sección: Tropa.
Marco Simbólico: La Aventura
Libro del Marco Simbólico: Escultismo para Muchachos
Lema: Siempre Listos
Color: Verde
 
Literatura de Apoyo: 
Escultismo para Muchachos. BP</b> 
...
a trabajar sin descanso y a no buscar más recompensa que el saber 
que hago Tu santa voluntad.  
Así sea.

Patrono de los Scout: San Jorge</b>
                     </p>
                     <a></a>
                  </div>
               </div>
               <div class="col-md-5">
                  <div class="infotmacion_img">
                     <figure><a href="https://es.wikipedia.org/wiki/San_Jorge"><img src="../images/San_Jorge.png" alt="#"/></a>
                     <p>
                 <b>Baden Powell</b> eligió a san Jorge como patrón de los scouts de todo el mundo. En "Escultismo para muchachos" escribió lo siguiente sobre el santo:

Tenían por patrono (los Caballeros de la Mesa Redonda) a San Jorge, porque éste era el único santo a caballo. Es el santo patrón de la Caballería y de Inglaterra. También es el santo patrono universal de los Scouts, por tanto, todos ellos deben conocer su historia.
                     </p>
                     </figure>
                  </div>
               </div>
